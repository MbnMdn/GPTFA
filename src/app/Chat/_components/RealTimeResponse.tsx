...
export default function RealTimeResponse() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            const apiKey = 'eyJhbGciOiJIUzUxMiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3MjkxMTUwOTUsInN1YiI6ImE2MmM5MmRiLTQ5MTktNGU4MS04ZjZjLWE5ODEzNTkxMzlhYSJ9.q_QuGs6pHS-eFZlJMMF7-B7PJVQvhDERTdr2UGHgAtnVuvVuJM_sUsHmFLio_hG8xqRoQXtc5ex8SL0lxRHc8Q';
